...
module.exports = client => {
  ...
  const serviceType = mdns.makeServiceType(['http', 'tcp', 'livingroom'])

  mdns.createAdvertisement(serviceType, 3000)
  app.context.ad = mdns.createAdvertisement(serviceType, 3000)
  app.context.ad.start()
  return app
}
